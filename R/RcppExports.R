...
LCA_fast_poly_includeall <- function(mY, mDesign, ivFreq, iK, mU, ivItemcat, first_poly, reord_user, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA_fast_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, ivFreq, iK, mU, ivItemcat, first_poly, reord_user, maxIter, tol, reord)
}

LCAcov_poly_includeall <- function(mY, mDesign, mZ, iK, mPhi, mBeta, mStep1Var, ivItemcat, fixed = 0L, maxIter = 1e3L, tol = 1e-8, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_LCAcov_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, mZ, iK, mPhi, mBeta, mStep1Var, ivItemcat, fixed, maxIter, tol, NRtol, NRmaxit)
}
...
LCA_fast_poly <- function(mY, ivFreq, iK, mU, ivItemcat, first_poly, reord_user, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA_fast_poly', PACKAGE = 'multilevLCA', mY, ivFreq, iK, mU, ivItemcat, first_poly, reord_user, maxIter, tol, reord)
}
...
LCA <- function(mY, iK, mU, reord_user, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA', PACKAGE = 'multilevLCA', mY, iK, mU, reord_user, maxIter, tol, reord)
}

LCA_fast <- function(mY, ivFreq, iK, mU, reord_user, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA_fast', PACKAGE = 'multilevLCA', mY, ivFreq, iK, mU, reord_user, maxIter, tol, reord)
}
...
MLTLCA_covWfixedlowhigh_poly_includeall <- function(mY, mDesign, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covWfixedlowhigh_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_covWfixedlowhigh_poly <- function(mY, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covWfixedlowhigh_poly', PACKAGE = 'multilevLCA', mY, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_covWfixed_poly_includeall <- function(mY, mDesign, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covWfixed_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_covWfixed_poly <- function(mY, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covWfixed_poly', PACKAGE = 'multilevLCA', mY, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_covlowhigh_poly_includeall <- function(mY, mDesign, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covlowhigh_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_cov_poly_includeall <- function(mY, mDesign, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, nsteps = 1L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_cov_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, nsteps, NRtol, NRmaxit)
}

MLTLCA_poly_includeall <- function(mY, mDesign, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, reord_user, reord_user_high, maxIter = 1e3L, tol = 1e-8, reord = 1L) {
    .Call('_multilevLCA_MLTLCA_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, reord_user, reord_user_high, maxIter, tol, reord)
}
...
MLTLCA_poly <- function(mY, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, reord_user, reord_user_high, maxIter = 1e3L, tol = 1e-8, reord = 1L) {
    .Call('_multilevLCA_MLTLCA_poly', PACKAGE = 'multilevLCA', mY, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, reord_user, reord_user_high, maxIter, tol, reord)
}
...
MLTLCA <- function(mY, vNj, vOmega, mPi, mPhi, reord_user, reord_user_high, maxIter = 1e3L, tol = 1e-8, reord = 1L) {
    .Call('_multilevLCA_MLTLCA', PACKAGE = 'multilevLCA', mY, vNj, vOmega, mPi, mPhi, reord_user, reord_user_high, maxIter, tol, reord)
}
