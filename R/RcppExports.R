...
MLTLCA_covlowhigh_poly <- function(mY, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_covlowhigh_poly', PACKAGE = 'multilevLCA', mY, mZ, mZh, vNj, mDelta_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, NRtol, NRmaxit)
}

MLTLCA_cov_poly <- function(mY, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter = 1e3L, tol = 1e-8, fixedpars = 0L, NRtol = 1e-6, NRmaxit = 100L) {
    .Call('_multilevLCA_MLTLCA_cov_poly', PACKAGE = 'multilevLCA', mY, mZ, vNj, vOmega_start, cGamma_start, mPhi_start, mStep1Var, ivItemcat, maxIter, tol, fixedpars, NRtol, NRmaxit)
}
