...
LCA_fast_poly_includeall <- function(mY, mDesign, ivFreq, iK, mU, ivItemcat, first_poly, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA_fast_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, ivFreq, iK, mU, ivItemcat, first_poly, maxIter, tol, reord)
}
...
LCA_fast_poly <- function(mY, ivFreq, iK, mU, ivItemcat, first_poly, maxIter = 1e3L, tol = 1e-8, reord = 0L) {
    .Call('_multilevLCA_LCA_fast_poly', PACKAGE = 'multilevLCA', mY, ivFreq, iK, mU, ivItemcat, first_poly, maxIter, tol, reord)
}
...
MLTLCA_poly_includeall <- function(mY, mDesign, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, maxIter = 1e3L, tol = 1e-8, reord = 1L) {
    .Call('_multilevLCA_MLTLCA_poly_includeall', PACKAGE = 'multilevLCA', mY, mDesign, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, maxIter, tol, reord)
}
...
MLTLCA_poly <- function(mY, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, maxIter = 1e3L, tol = 1e-8, reord = 1L) {
    .Call('_multilevLCA_MLTLCA_poly', PACKAGE = 'multilevLCA', mY, vNj, vOmega, mPi, mPhi, ivItemcat, first_poly, maxIter, tol, reord)
}
